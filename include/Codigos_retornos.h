...
enum Localizar_retornos {LOCALIZACION_ERROR_NO_EXISTE, LOCALIZACION_EXITOSA, LOCALIZACION_ERROR_IMPOSIBLE_LOCALIZAR};

enum Alta_retornos {ALTA_ERROR_CODIGO_EXISTENTE, ALTA_EXITOSA , ALTA_ERROR_LISTA_LLENA, ALTA_ERROR_IMPOSIBLE_REALIZAR};
